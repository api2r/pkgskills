...
- [`update_ai()`](https://pkgskills.api2r.org/reference/update_ai.md)
  ...
  `overwrite = TRUE` by default (#noissue).
...
- [`use_ai()`](https://pkgskills.api2r.org/reference/use_ai.md) now
  works when called via
  [`pkgskills::use_ai()`](https://pkgskills.api2r.org/reference/use_ai.md)
...
- [`vignette("pkgskills")`](https://pkgskills.api2r.org/articles/pkgskills.md)
  ...
  [`use_ai()`](https://pkgskills.api2r.org/reference/use_ai.md) setup,
  skill descriptions, and issue-writing best practices
  ([\#31](https://github.com/api2r/pkgskills/issues/31)).

- [`use_ai()`](https://pkgskills.api2r.org/reference/use_ai.md) sets up
  the full AI agent suite in a single call, installing `AGENTS.md`, the
  GitHub Copilot workflow, and all selected skills
...
- [`use_skill_implement_issue()`](https://pkgskills.api2r.org/reference/use_skill_implement_issue.md)
  installs the `implement-issue` skill into the target project
  ([\#18](https://github.com/api2r/pkgskills/issues/18)).

- [`use_skill_github()`](https://pkgskills.api2r.org/reference/use_skill_github.md)
...
- [`use_skill_search_code()`](https://pkgskills.api2r.org/reference/use_skill_search_code.md)
...
- [`use_skill_document()`](https://pkgskills.api2r.org/reference/use_skill_document.md)
