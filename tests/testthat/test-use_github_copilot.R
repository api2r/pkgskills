test_that("use_github_copilot() installs copilot-setup-steps.yml (#17)", {
  proj_dir <- local_pkg()
...
test_that("use_github_copilot() installs install/action.yml (#17)", {
  proj_dir <- local_pkg()
  suppressMessages(use_github_copilot(open = FALSE))
  expect_true(
    fs::file_exists(
...
test_that("use_github_copilot() returns path to copilot-setup-steps.yml invisibly (#17)", {
  proj_dir <- local_pkg()
...
test_that("use_github_copilot() errors if copilot-setup-steps.yml exists and overwrite = FALSE (#17)", {
...
test_that("use_github_copilot() errors if install/action.yml exists and overwrite = FALSE (#17)", {
...
test_that("use_github_copilot() overwrites files when overwrite = TRUE (#17)", {
  proj_dir <- local_pkg(
...
test_that("use_github_copilot() checks both paths before writing either (#17)", {
